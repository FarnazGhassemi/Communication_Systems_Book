...
%   Sara Khamseh.                                              %
%   Version.2:             04/01/27                            %
%   The second version Contributed voluntirely by              %
%   Fatemeh Yazdani.                                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%------------------------- Discription ------------------------
...
%          Letters are separated by apastrophe ''', words by '/'.
...
%          Aplphabets and space (00100) are supported. characters are 
%           seperated using apastrophe '''. It returns 5 asterisks if 
%           the binary code is unsupported.
%
%   Functions:
