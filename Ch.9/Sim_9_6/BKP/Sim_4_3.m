%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%          Illustrating Chapter 4: Linear Modulation           %
%                                    DSB Modulator             %
%                                                              %
...
%                                                              %
%                                                              %
%   Version.2:             03/11/19---Dr.Ghassemi              %
...
xlabel('Time')
ylabel('Amplitude')
title('The DSB Modulated signal')
grid on
hold on
...
plot(t,envelope(u(1:length(t))),'Color', colors(7,:),'LineStyle',marks{2},'LineWidth', 2)
plot(t,envelope(u(1:length(t)))-mean(envelope(u(1:length(t)))),'Color', colors(12,:),'LineStyle',marks{2},'LineWidth', 2)
legend('DSB Modulated Signal','Message Signal with DC Offset','Message Signal')
...
xlabel('Time')
ylabel('Amplitude')
title('The DSB Modulation') 
grid on
hold on
plot(t,envelope(u(1:length(t)))*22,'Color', colors(7,:),'LineWidth', 1)
%plot(t,(envelope(u(1:length(t)))-mean(envelope(u(1:length(t)))))*22,'Color', colors(11,:),'LineStyle',marks{2},'LineWidth', 2)
legend('Message Signal','DSB Modulated Signal')%,'Message Signal with DC Offset')
